package org.example.cinefinal.peliculas.controllers
...
//        comboTipo.selectionModel.selectFirst()
        //tabla
        TablaPeliculas.items = FXCollections.observableArrayList(viewModel.state.value.peliculas)
    ...
    private fun filterDataTable() {
        ...
        TablaPeliculas.items =
            FXCollections.observableList(viewModel.peliculasFilteredList(TextBuscadorPeliculas.text.trim()))
    }
}